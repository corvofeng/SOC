...
void parse_file(FILE *fptr,FILE *intptr, int pass, char *instructions[], size_t inst_len, hash_table_t *hash_table, FILE *outProg, FILE *outProgInt, FILE *outInt, FILE *outData);
