...
struct {
    ...
    { "zero", "00000" }, //å¸¸é‡0
    { "at", "00001" },	//ä¿ç•™ç»™æ±‡ç¼–å™¨
    { "v0", "00010" },  //$v0-$v1å‡½æ•°è°ƒç”¨è¿”å›å€¼
    { "v1", "00011" },
    { "a0", "00100" },	//$a0-$a3å‡½æ•°è°ƒç”¨å‚æ•°
    { "a1", "00101" },
    { "a2", "00110" },
    { "a3", "00111" },
    { "t0", "01000" },	//$t0-$t9æš‚æ—¶å¯„å­˜å™¨
    { "t1", "01001" },
    { "t2", "01010" },
    { "t3", "01011" },
    { "t4", "01100" },
