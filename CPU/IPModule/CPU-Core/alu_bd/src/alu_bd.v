...
module alu_bd
  ...
  alu_bd_andgate_1_0 andgate_1
       (.a(A_1),
        .b(B_1),
        .c(andgate_1_c));
  alu_bd_input0_1_0 input0_1
       (.zero(input0_0_zero));
  alu_bd_input1_1_0 input1_1
       (.zero(input1_1_zero));
  ...
  alu_bd_mux2to1_1_0 mux2to1_1
       (.a0(input0_0_zero),
        ...
        .q(mux2to1_1_q),
        .s(mux2to1_0_q));
  alu_bd_my_8mux1_1_0 my_8mux1_1
       (.a0(addsub_0_sum),
        .a1(mux2to1_1_q),
        .a2(andgate_1_c),
        .a3(orgate_0_c),
  ...
  alu_bd_my_alu_ctr_input_0_0 my_alu_ctr_input_0
       (.ALGctr(my_alu_ctr_input_0_ALGctr),
        ...
        .SUBctr(SUBctr_1));
  alu_bd_my_shift_0_0 my_shift_0
       (.A(A_1),
        .ALGctr(my_alu_ctr_input_0_ALGctr),
        .B(B_1),
