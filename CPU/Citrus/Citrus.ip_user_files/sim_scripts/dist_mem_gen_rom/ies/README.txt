...
#
# Generated by export_simulation on Tue Sep 19 08:52:38 CST 2017
#
################################################################################
...
switch to the './dist_mem_gen_rom.sh' script.

./dist_mem_gen_rom.sh -reset_run
...
./dist_mem_gen_rom.sh -noclean_files

For more information on the script, please type './dist_mem_gen_rom.sh -help'.
